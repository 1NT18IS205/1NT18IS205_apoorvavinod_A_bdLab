import java.io.IOException; // input and output operations of the java code
...
import org.apache.hadoop.mapreduce.Job; // creates a job with no particular clusters
import org.apache.hadoop.mapreduce.Mapper; // transforms the input records into intermediate records
import org.apache.hadoop.mapreduce.Reducer; // reducer copies the sorted output from each mapper 
import org.apache.hadoop.mapreduce.Reducer.Context; // implenatation of configuration
import org.apache.hadoop.mapreduce.lib.input.FileInputFormat; // base class for all the file-based input formats
import org.apache.hadoop.mapreduce.lib.output.FileOutputFormat; // base class for outputformats that read from file systems
...
public class WordCount{
  ...
  public static class TokenizerMapper
	...
	private Text word = new Text(); // creating an object word as private
  ...
  public static void main(String[] args) throws Exception { // here set method works until the work is done
	...
	job.setJarByClass(WordCount.class);            //tells the nodes where to look for Mapper & Reduce classes
